            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "limit": {
                        "type": "integer",
                        "default": 100,
                        "description": "The maximum number of items (files + directories) to return.",
                    },
                    "recursive": {
                        "type": "boolean",
                        "default": False,
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    "path": {
                        "type": "string",
                        "description": "The absolute path to the directory to start the search.",
                    },
                    "keywords_path_name": {
                        "type": "array",
                        "items": {"type": "string"},
            ...
            "inputSchema": {
                ...
                "properties": {
                    "paths": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "A list of absolute file or directory paths to delete.",
                    }
                },
                "required": ["paths"],
            },
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "start_offset_inclusive": {
                        "type": "integer",
                        "default": 0,
                        "description": "The 0-indexed starting offset (inclusive).",
                    },
                    "end_offset_inclusive": {
                        "type": "integer",
                        "default": -1,
                        "description": "The 0-indexed ending offset (inclusive, -1 for end of file).",
                    },
                    "offset_type": {
                        "type": "string",
                        "enum": ["line", "char", "byte"],
